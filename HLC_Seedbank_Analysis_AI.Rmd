...
seedbank <- read.csv("./20220714_HLC_SB_Data_Final2.csv")
...
#I don't know if below is necessary or not yet for any of the variables
...
df_Spp <- distinct(seedbankdf, Species_Name, .keep_all = TRUE) %>%
  ...
  select(Species_Name, Bank_Gradient, Longevity_2, Habit, Functional_Group_2, Origin, WIS)

View(df_Spp)

#Export to Excel
write_xlsx(df_Spp, 'SB_SpeciesList_AI_07222022.xlsx') 
