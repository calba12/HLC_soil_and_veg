...
emmip(lmer_sb4, WIS ~ Bank_Location, CIs = TRUE, linearg = list(),
  ...
  ggplot2::theme_bw()  +
  ylab("Linear Prediction of Seed Bank WIS") +       
  xlab("Bank Location") +
  ggtitle("Seed Bank")
...
emmip(lmer_gaus_native_4, Nativity ~ Bank_Location, CIs = TRUE, linearg = list(),
      CIarg = list(lwd = 1, alpha = 1)) +
  ggplot2::theme_bw() +
  ylab("Linear Prediction of Seed Bank Nativity") +       
  xlab("Bank Location") +
  ggtitle("Seed Bank")
...
#customizations
emmip(lmer_gaus_fg_4, Functional_Group_2 ~ Bank_Location, CIs = TRUE, linearg = list(),
      CIarg = list(lwd = 1, alpha = 1)) +
  ggplot2::theme_bw()+
  ylab("Linear Prediction of Seed Bank Functional Group") +       
  xlab("Bank Location") +
  ggtitle("Seed Bank") +
  scale_fill_discrete(name = "Functional Group") #not able to change legend title yet
  

emmip(lmer_gaus_fg_4, Functional_Group_2 ~ Bank_Location, linearg = list(),
      CIarg = list(lwd = 1, alpha = 1)) +
  ggplot2::theme_bw() +
  ylab("Linear Prediction of Seed Bank Functional Group") +       
  xlab("Bank Location") +
