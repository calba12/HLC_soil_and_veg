...
glmer_pois_null <- glmer(prop ~ 1 + (1|Baseline) + (1|Transect_ID:Baseline), data = df.props_WIS_seed, family = poisson(link = log)) #intercept only, just models variation across baselines and transects, no accounting for variation explained by WIS
