...
#Mac path
seedbank <- read.csv("20220802_HLC_SB_Data_Final4.csv")
getwd()
...
WIS <- df_WIS_means %>% 
  ...
  ggplot(aes(x=factor(WIS), y=Mean, fill=WIS))+ 
    ggtitle("Wetland Indicator Status Proportion by Bank Location") +
  geom_boxplot()+
    geom_point()+
...
FGroup2 <- df_FGroup_means %>% 
  ggplot(aes(x=Functional_Group_2, y=Mean, fill=Functional_Group_2))+ 
    ggtitle("Functional Group Proportion by Bank Location") +
  geom_boxplot()+
    geom_point()+
