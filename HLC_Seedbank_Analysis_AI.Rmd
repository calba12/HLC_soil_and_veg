...
RankAbund_seed <- df_RankAbund_means_seed2 %>%
  ...
  filter(Species_Name == "Taraxacum officinale"
         ...
         | Species_Name == "Descurainia sophia" 
         | Species_Name == "Dactylis glomerata") %>%
  mutate(Species_Name = fct_relevel(Species_Name, "Taraxacum officinale", "Juncus sp.", "Phalaris arundinacea", "Rumex crispus", "Rorippa palustris", "Bromus tectorum", "Capsella bursa-pastoris",  "Carex sp.", "Plantago major", "Carex emoryi", "Descurainia sophia", "Dactylis glomerata")) %>% 
