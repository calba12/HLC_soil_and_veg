...
#revisit coloring on this; what do I want to highlight

p + scale_fill_manual(values = c("antiquewhite4", "aquamarine4", "bisque3", "blue1", "antiquewhite4",
                                 "cadetblue", "chocolate", "cadetblue", "deepskyblue1", "darkseagreen",
                                 "darkolivegreen2","darkorchid2", "darkorchid2", "cadetblue", "aliceblue", "darkseagreen"))
