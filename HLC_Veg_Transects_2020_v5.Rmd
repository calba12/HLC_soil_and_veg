...
library(ggpubr); library(rstatix);library(writexl);library(ggformula); library(tidyr);library(reshape2); library(sjPlot); library(emmeans); library(RColorBrewer)
...
#FOR THE BELOW STATS, NEED TO CREATE A DATAFRAME USING THE PREPPING
#CODE ABOVE BUT KEEP TRANSECTS FOR RANDOM STATEMENT
#Stats model for proportion of species upper bank location; Gaussian family fixed and random effects
#First select out the upper bank location only
