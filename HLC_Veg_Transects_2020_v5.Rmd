...
#Need to figure out how to plot only the 9 baselines, not all 45 transects
...
df_NatIntro_baseline_means %>% ggplot(aes(x=Location, y=Mean))+
  geom_boxplot()+
  geom_point()+

  labs(x = "Bank Location", y = "Proportion of Native Cover")+
