...
#Need to recreate WIS proportion data file for analysis b/c Chrissy used WMVC WIS rather than GP WIS
#Number of species hits grouped by sample bout and hit number, then remove sample bout two, then create proportion of hits by response variable
