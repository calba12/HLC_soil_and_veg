...
save(species.wide2, file = "species_wide.RData")

species.wide2 <- species.wide[-c(1:3)]
vspecies.wide2

vegdist <- vegdist(species.wide2, method="bray", binary=TRUE)
matrix <- as.matrix(vegdist)
view(matrix)
...
as.matrix(species.wide)[df$species.wi==,df$PoolNumber==4]
