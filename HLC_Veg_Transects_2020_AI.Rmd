...
Spp_count_tbl <- vegdf %>% 
  group_by(VegHit_SoilSurfaceHit, Longevity, Habit, WIS_GP, Nativity, Cvalue) %>%
  summarise(Freq2 = n()) %>%
  subset(VegHit_SoilSurfaceHit!="bare soil" & VegHit_SoilSurfaceHit!="downed woody debris"
         & VegHit_SoilSurfaceHit!="litter" & VegHit_SoilSurfaceHit!="rock" & VegHit_SoilSurfaceHit!="water")
...
#original code at top, AI code at bottom of chunk
...
```{AI - r graph WIS by bank location then move on to statistical model}
