...
veg <- read.csv("20201204_allHitsData_postQC_prep4.csv") #mac
...
df_Spp_bout1 <- distinct(df_bout1, VegHit_SoilSurfaceHit, .keep_all = TRUE) %>%
  ...
  select(VegHit_SoilSurfaceHit, Longevity, Habit, WIS_GP, Nativity)
...
write_xlsx(Spp_prop_tbl, 'Veg_SppList_Prop4_AI08202022.xlsx')
